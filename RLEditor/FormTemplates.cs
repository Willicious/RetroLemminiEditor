...
namespace RLEditor
{
    public partial class FormTemplates : Form
    {
        ...
        internal FormTemplates(RLEditForm parentForm, Settings settings)
        {
            InitializeComponent();
            mainForm = parentForm;
        ...
        private void PopulateTemplatesList(int index = 0)
        {
            ...
            try
            {
                ...
                foreach (var file in files)
                {
                    try
                    {
                        Level level = LevelFile.LoadMetaData(file, mainForm.StyleList);
        ...
        private void PopulateTemplateDataPanel()
        {
            ...
            // --- RR/SI / Time ---
            string lockedText = level.IsReleaseRateLocked ? "(Locked)" : "";

            AddLine($"Release Rate: ", $"{level.MinReleaseRate}-{level.MaxReleaseRate} {lockedText}");
