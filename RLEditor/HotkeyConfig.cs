    ...
    public class HotkeyConfig
    {
        ...
        public static readonly List<HotkeyData> AllHotkeys = new List<HotkeyData>
        {
            ...
            new HotkeyData(HotkeyName.HotkeyToggleTerrain,
                "Toggle Terrain",
                Keys.F2),
            new HotkeyData(HotkeyName.HotkeyToggleSteel,
                "Toggle Steel",
            ...
            new HotkeyData(HotkeyName.HotkeyToggleScreenStart,
                "Toggle Screen Start",
                Keys.F5),
            new HotkeyData(HotkeyName.HotkeyToggleSteelAreas,
                "Toggle Rulers",
                Keys.F6),
            ...
            new HotkeyData(HotkeyName.HotkeyOpenPieceBrowserWindow,
                ...
                Keys.Control | Keys.B),
            new HotkeyData(HotkeyName.HotkeyOpenPiecesList,
                "Open Pieces List",
                Keys.Control | Keys.P),
            ...
            new HotkeyData(HotkeyName.HotkeyOpenConfigHotkeys,
                "Open Hotkey Config",
                Keys.F11),
            new HotkeyData(HotkeyName.HotkeyOpenAboutRL,
                "Open About",
            ...
            new HotkeyData(HotkeyName.HotkeySelectPiecesBelow,
                ...
                true),
            new HotkeyData(HotkeyName.HotkeyCycleSelectPieces,
                "Cycle Selection Through All Pieces Under Cursor",
                Keys.Shift | Keys.LButton,
                true),
