...
namespace RLEditor
{
    ...
    class Level : IEquatable<Level>
    {
        ...
        public Level Clone()
        {
            ...
            newLevel.BottomBoundary = this.BottomBoundary;
            newLevel.LeftBoundary = this.LeftBoundary;
            newLevel.RightBoundary = this.RightBoundary;
        ...
        /// </summary>
        public void AddPiece(string pieceKey, string style, Point pos, int gridSize, bool useSelectedPos = false)
        {
            int piecePosX = pos.X;
            int piecePosY = pos.Y;
