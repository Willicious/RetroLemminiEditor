...
namespace RLEditor
{
    ...
    public class RepeatButton : NoPaddingButton
    {
        public RepeatButton() : base()
        {
            ...
            buttonTimer.Tick += new EventHandler(delegate (Object obj, EventArgs e)
            { ButtonTimer_Tick(); });

            this.MouseDown += new MouseEventHandler(delegate (Object obj, MouseEventArgs e)
            { RepeatButton_MouseDown(e); });
            this.MouseUp += new MouseEventHandler(delegate (Object obj, MouseEventArgs e)
            { RepeatButton_MouseUp(e); });
        ...
        {
            if (!buttonIntervals.Keys.Contains(e.Button))
                return;
